...
function Help()
{
  ...
  echo
  echo "Example: ./osdu_helm_install.bash -r airflow2 -n airflow2 -c oci://msosdu.azurecr.io/helm/osdu-airflow2 -v 1.17.0"
  echo "Example: ./osdu_helm_install.bash -r partition-services -n osdu-azure -c oci://msosdu.azurecr.io/helm/osdu-azure -v 1.17.0 -s osdu-partition_base"
  echo
}
