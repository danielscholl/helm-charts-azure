...
function _check_default_values() {
  ...
  if [[ -z $HOSDU_AIRFLOW2_VERSION ]]; then export HOSDU_AIRFLOW2_VERSION=1.20.0; echo "[WARN] No HOSDU_AIRFLOW2_VERSION env, using default => $HOSDU_AIRFLOW2_VERSION"; fi
  if [[ -z $HOSDU_AZURE_VERSION ]]; then export HOSDU_AZURE_VERSION=1.20.0; echo "[WARN] No HOSDU_AZURE_VERSION env, using default => $HOSDU_AZURE_VERSION"; fi
  if [[ -z $HOSDU_DMS_VERSION ]]; then export HOSDU_DMS_VERSION=1.20.0; echo "[WARN] No HOSDU_DMS_VERSION env, using default => $HOSDU_DMS_VERSION"; fi
