...
cat > ./local/osdu_ds-helper-services_custom_values.yaml << EOF
...
# Make sure current location is /helm-charts-azure/osdu-azure/data-seeding/charts/ds-helper-services

# Install Charts
helm install helper-services-data-seeding . -n $NAMESPACE -f ./local/osdu_ds-helper-services_custom_values.yaml
```