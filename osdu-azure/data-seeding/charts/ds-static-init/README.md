...
cat > ./local/osdu_ds-static-init_custom_values.yaml << EOF
...
# Make sure current location is /helm-charts-azure/osdu-azure/data-seeding/charts/ds-static-init

# Install Charts
helm install data-seeder . -n $NAMESPACE -f ./local/osdu_ds-static-init_custom_values.yaml
```